<li class="group/li relative flex items-start gap-4 pt-4">
    ...
    <a href="/profile" class="isolate shrink-0">
        <img src="{{ $replay->profile->avatar }}" alt="Avatar for {{ $replay->profile->displayName }}" class="size-10 object-cover" />
    </a>
    <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-2.5">
                <p>
                    <a class="hover:underline" href="/profile">{{ $replay->profile->displayName }}</a>
                </p>
                <p class="text-pixl-light/40 text-xs">{{ $replay->postedAgo }}h</p>
                <p>
                    <a class="text-pixl-light/40 hover:text-pixl-light/60 text-xs" href="/profile">{{ $replay->profile->handle }}</a>
                </p>
            </div>
        ...
        <div class="mt-6 flex items-center justify-between gap-4">
            <div class="flex items-center gap-8">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <span class="text-sm">{{ $replay->likeCount }}</span>
                </div>
                <!-- Comment -->
                <div class="flex items-center gap-1">
                    ...
                    <span class="text-sm">{{ $replay->replayCount }}</span>
                </div>
                <!-- Re-post -->
                <div class="flex items-center gap-1">
                    ...
                    <span class="text-sm">{{ $replay->repostCount }}</span>
                </div>
            </div>
