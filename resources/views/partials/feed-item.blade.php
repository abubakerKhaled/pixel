<li class="flex items-start gap-4 not-first:pt-2.5">
    <a href="/profile" class="shrink-0">
        <img src="{{ $feedItem->profile->avatar }}" alt="Avatar for {{ $feedItem->profile->displayName }}"
    ...
    <div class="grow pt-1.5">
            ...
            <div class="mt-6 flex items-center justify-between gap-4">
                <div class="flex items-center gap-8">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm">{{ $feedItem->likeCount }}</span>
                    </div>
                    <!-- Comment -->
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm">{{ $feedItem->replayCount }}</span>
                    </div>
                    <!-- Re-post -->
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm">{{ $feedItem->repostCount }}</span>
                    </div>
                </div>
        ...
        <ol>
            ...
            @foreach ($replies as $replay)
                @include('partials.feed-item-replay', ['replay' => $replay])
            @endforeach
            <!-- More replies... -->
        </ol>
    </div>
