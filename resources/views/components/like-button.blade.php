...
<div class="flex items-center gap-1" x-data="{
    ...
    <button type="button" aria-label="Like" x-on:click="toggle()" class="hover:text-pixl"
        :class="{ 'text-pixl': liked }">
    ...
    <span class="hover:text-pixl text-sm" :class="{ 'text-pixl': liked }" x-text="count"></span>
</div>