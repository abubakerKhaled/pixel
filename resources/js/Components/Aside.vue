<script setup>
import ArtistsToFollow from '@/Components/ArtistsToFollow.vue'
...
<template>
    <!-- Sidebar -->
    <aside class="-mx-4 my-4 hidden w-80 shrink-0 min-h-0 overflow-y-auto px-4 lg:block">
        ...
        <ArtistsToFollow :profiles="artistsToFollow" />
