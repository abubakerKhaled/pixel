...
<template>
    <Head title="Pixel | A place for the cool squares." />

    <div class="relative flex h-dvh w-full flex-col bg-pixl-dark text-pixl-light md:block md:overflow-clip">
        <!-- Background image -->
            ...
            <div class="gap:8 flex w-full flex-col items-center justify-between md:flex-row md:gap-16">
                ...
                <div class="max-w-full pb-16 min-[360px]:w-72 sm:w-80">
                    ...
                    <div class="mt-8 flex flex-col gap-3 text-center sm:mt-12 md:mt-16 md:w-68">
                        <Link class="border border-pixl/50 bg-pixl-dark/50 px-4 py-1.5 text-pixl transition-all duration-200 hover:border-pixl/60 hover:bg-pixl-dark/60 active:border-pixl/75 active:bg-pixl-dark/75"
                            :href="index.url()" role="button">Sign in with Google</Link>
                        <Link class="border border-pixl/50 bg-pixl-dark/50 px-4 py-1.5 text-pixl transition-all duration-200 hover:border-pixl/60 hover:bg-pixl-dark/60 active:border-pixl/75 active:bg-pixl-dark/75"
